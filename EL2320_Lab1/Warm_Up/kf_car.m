...
D = 1;
R = diag([0.01^2 0.1^2]);
%R=100*diag([0.01^2 0.1^2]) %for question 3 to increase the covariance matrix of the modeled process noise 100 times 
%R=1/100*diag([0.01^2 0.1^2]) %for question 3 to decrease the covariance matrix of the modeled process noise 100 times 
Q = 0.1^2;
%Q = 100*0.1^2 %for question 3 to increase the covariance matrix of the modeled measurement noise 100 times 
%Q =1/100*0.1^2 %for question 3 to decrease the covariance matrix of the modeled measurement noise 100 times 
